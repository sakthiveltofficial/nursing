  ...
  return (
    <div className="w-full">
      ...
      <section className="w-full relative overflow-hidden">
        <div className="relative z-10 flex items-center w-full px-4 sm:px-6 md:px-8  py-8 sm:py-6 md:py-16 lg:py-20">
          <div className="text-center w-full">
            <h1 className=" text-black text-xl sm:text-3xl md:text-4xl lg:text-[85PX] xl:text-[75px] 2xl:text-[90px] font-normal tracking-[0%] mb-6 sm:mb-0 leading-tight" ref={titleRef}>
              Your Nursing Career Starts Here
            </h1>
            <h2 className=" text-[#FB7185] text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-[85px] font-normal tracking-[0%] mt-0 sm:-mt-2 md:-mt-3 lg:-mt-4 mb-6 sm:mb-6 md:mb-8 leading-tight" ref={collegeRef}>
              AJK Nursing College
            </h2>
            <div className="hidden sm:block text-[#333333] text-xs sm:text-sm md:text-base font-extralight tracking-[0%] opacity-100 mt-6 sm:mt-8 md:mt-10 lg:mt-15 px-2 sm:px-4 md:px-8 lg:px-12 xl:px-20" ref={subText1Ref}>
            ...
            <div className="hidden sm:block mt-6 sm:mt-6 md:mt-8 lg:mt-10" ref={buttonRef}>
              <Button type="button" />
            </div>
          </div>
        </div>
      ...
      <section className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-30 py-6 sm:py-8 md:py-10 lg:py-12">
        <div className="w-full rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-4xl p-4 sm:p-6 md:p-8 lg:p-12 xl:p-15 bg-gradient-to-br from-[#fff7fa] to-[#ffffff] shadow-lg">
          <h2 className="text-[#FF6B95] text-lg sm:text-xl md:text-2xl lg:text-3xl font-normal leading-tight mb-3 sm:mb-4 md:mb-6">
            About the Nursing Profession
          </h2>
          <p className="text-[#555] text-xs sm:text-sm md:text-base font-light tracking-[0%] leading-relaxed">
            Nursing has a profound impact on people's lives and health. As medical technology evolves, it continues to transform the nursing profession and the healthcare system. Today, nurses bring knowledge, leadership, and vital expertise to expanding roles that offer increased participation, responsibility, and rewards. Nursing duties are manifold and cover a wide range of functions and responsibilities that vary with the level of qualification and the working environment.
          </p>
        </div>
      </section>
      ...
      <section className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-30 py-6 sm:py-8 md:py-10 lg:py-12">
        <div className="w-full rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-4xl p-4 sm:p-6 md:p-8 lg:p-12 xl:p-15 bg-gradient-to-br from-[#fff7fa] to-[#ffffff] text-left lg:text-right shadow-lg">
          <h2 className="text-[#2F0014] text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-[30px] font-semibold mb-3 sm:mb-4 md:mb-6 tracking-[0%]">
            B.Sc. Nursing Program
          </h2>
          <p className="text-[#555] text-xs sm:text-sm md:text-base font-light tracking-[0%] leading-relaxed">
            B.Sc. Nursing or Bachelor of Science in Nursing is a comprehensive 4-year undergraduate course designed to equip students with both theoretical knowledge and practical skills essential for the nursing profession. The program includes eight semesters of coursework and a six-month internship, ensuring a well-rounded education in nursing concepts.
          </p>
        </div>
      </section>
      ...
      <section 
        className="w-full lg:min-h-screen relative py-6 sm:py-8 md:py-10 lg:py-12"
        style={{
        ...
        <div ref={containerRef} className="relative z-10 w-full">
          <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-16">
              ...
              <div ref={leftSectionRef} className="w-full lg:w-1/2 lg:sticky lg:top-20 lg:h-screen lg:flex lg:flex-col">
                <div className="space-y-4 sm:space-y-6">
                  <h1 className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-[84px] font-normal text-[#9A8C92] leading-tight text-center lg:text-left">
                    Courses of Study
                    <br />
                    <span className="text-[#9A8C92]">in B.Sc. Nursing</span>
                  </h1>
              ...
              <div ref={rightSectionRef} className="w-full lg:w-1/2 lg:py-20">
                <div className="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
                  {courseSections.map((section) => (
                    <div key={section.id} className="scroll-item">
                      {/* Section Header */}
      ...
      {/* Admission Criteria Grid Section */}
      <section className="w-full pb-20 sm:pb-30 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 py-20 sm:py-30">
